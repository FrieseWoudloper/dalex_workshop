...
```{r rf-titanic, exercise=TRUE, exercise.eval=FALSE}
library(ranger)
set.seed(1313)
...
```{r explain-rf-titanic, exercise=TRUE, exercise.eval=FALSE}
library(DALEX)
exp_rf <- explain(___,
                  data = titanic_imputed[, 1:7],
                  y = ___$survived,
...
```{r sh-joe-lms-titanic, exercise=TRUE, exercise.eval=FALSE}
