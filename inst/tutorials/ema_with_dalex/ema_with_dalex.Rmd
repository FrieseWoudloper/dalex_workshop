...
## 2 Titanic dataset
We will use the `titanic_imputed` dataset. It is a list of people who were on board the Titanic when it sank. Run `?DALEX::titanic_imputed` in R for detail information about the dataset.

In the next steps of this tutorial we will train two different kind of model. They both predict whether a person will survive.
