...
Because the Titanic dataset is low-dimensional, we would probably not use LIME in practice. LIME is usually only applied for high-dimensional data, like text and images. However, as an example, we use the LIME method to explain Johnny D's prediction for the random forest model. 
