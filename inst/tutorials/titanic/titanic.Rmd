...
We use the implementation in the `lime` package and specify the maximum number of explanatory variables to be selected (`n_features = 3`) and the number of artificial data points (`n_permutations = 1000`)
